...
introduction that explains the problem, why it is important that the problem needs to be addressed with a visualization, the potential users or user groups, and what your general approach would be.

\section{Visualization Tasks}

what questions are you hoping to address with the visualization
